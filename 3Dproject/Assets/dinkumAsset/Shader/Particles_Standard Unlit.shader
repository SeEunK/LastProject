...
SubProgram "d3d11 " {
Keywords { "SHADOWS_CUBE" }
Local Keywords { "_COLORADDSUBDIFF_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "SHADOWS_CUBE" }
...
SubProgram "d3d11 " {
Keywords { "FOG_LINEAR" "INSTANCING_ON" "SOFTPARTICLES_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "FOG_LINEAR" "INSTANCING_ON" "SOFTPARTICLES_ON" }
...
SubProgram "d3d11 " {
Local Keywords { "EFFECT_BUMP" "_ALPHABLEND_ON" "_COLORADDSUBDIFF_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Keywords { "INSTANCING_ON" }
